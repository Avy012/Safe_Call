      ...
      >
        <Tabs.Screen
          ...
          options={{
            ...
            headerShown: false,
            tabBarIcon: ({ focused }) => (
              <TabIcon focused={focused} icon={icons.home} title="메인" />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            headerShown: false,
            tabBarIcon: ({ focused }) => (
              <TabIcon focused={focused} icon={icons.person} title="연락처" />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            headerShown: false,
            tabBarIcon: ({ focused }) => (
              <TabIcon focused={focused} icon={icons.call} title="통화 기록" />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            headerShown: false,
            tabBarIcon: ({ focused }) => (
              <TabIcon focused={focused} icon={icons.chat} title="채팅" />
            ),
          }}
        />
      </Tabs>
